            ...
            cmake_executor = { -- executor to use
                ...
                default_opts = { -- a list of default and possible values for executors
                    quickfix = {
                        ...
                        size = 10,
                        encoding = "utf-8", -- if encoding is not utf-8, specify the correct one
                    ...
                    terminal = {
                        ...
                        keep_terminal_static_location = true, -- Static location of the viewport, if false the position will change based on the last opened viewport

                        -- Running Tasks
                        start_insert = false, -- If you want to enter terminal with :startinsert upon using :CMakeRun
                        focus_on_main_terminal = false, -- Focus on cmake terminal when cmake task is launched.
                        focus_on_launch = false, -- Focus on the cmake launch terminal when used.
                    },
                },
            },
